...
import DashboardOverview0 from '../views/dashboard-overview-0/Main'
...
import DashboardOverview7 from '../views/dashboard-overview-7/Main'
import DashboardOverview8 from '../views/dashboard-overview-8/Main'
import DashboardOverview9 from '../views/dashboard-overview-9/Main'
  ...
  const routes = [
    {
      ...
      children: [
        ...
        {
          path: 'dashboard-overview-0',
          element: <DashboardOverview0 />,
        },
        {
        ...
        {
          path: 'dashboard-overview-9',
          element: <DashboardOverview9 />,
        },
        {
          path: 'categories',
          element: <Categories />,
